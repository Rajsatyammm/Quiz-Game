...
mainhome:
    ...
    home:
        ...
        {
            system("cls");
            random = generateRandomNumber(15) + 1;
            //random = i;
            ...
            case 7:
                ...
                {
                    printf("\n\nWrong!!! The correct answer is B. Apple");
                    getch();
                    break;
                }
            case 8:
            ...
            case 9:
                printf("\n\n\nThe rules of a language is known as ____");
                printf("\n\nA. Syntax\t\tB. Structure\n\nC. Procedure\t\tD. Code");
                if (toupper(getch()) == 'A')
                {
                    printf("\n\nCorrect!!!");
                    count++;
                ...
                {
                    printf("\n\nWrong!!! The correct answer is A. Syntax");
                    getch();
                    break;
                }
            case 10:
                ...
                {
                    printf("\n\nWrong!!! The correct answer is C. Radiation");
                    getch();
                    break;
                }
            case 11:
                printf("\n\n\nHow many moles are there is 140 g of Si (atomic mass of silicon is 28)?");
                printf("\n\nA. 5\t\tB. 65\n\nC. 6\t\tD. 58");
                if (toupper(getch()) == 'A')
                {
                    printf("\n\nCorrect!!!");
            ...
            case 12:
                printf("\n\n\nGun Powder is a mixture of ______?");
                printf("\n\nA. Sulphur, Bromine and Nitre\t\tB. Sulphur, Carbon and Nitre\n\nC. Sulphur, Copper and Nitre\t\tD.  Sulphur, Argon and Nitre");
                if (toupper(getch()) == 'B')
                {
                    printf("\n\nCorrect!!!");
                    count++;
                ...
                {
                    printf("\n\nWrong!!! The correct answer is B. Sulphur, Carbon and Nitre");
                    getch();
                    break;
                }
            case 13:
                printf("\n\n\nGroup 0 elements are ____________");
                printf("\n\nA. Unreactive non metals\t\tB. Reactive non metals\n\nC. Reactive metals\t\tD. Unreactive metals");
                if (toupper(getch()) == 'A')
                {
                    printf("\n\nCorrect!!!");
                    count++;
                ...
                {
                    printf("\n\nWrong!!! The correct answer is A. Unreactive non metals");
                    getch();
                    break;
                }
            case 14:
                printf("\n\n\nAmong the given nutrients, milk is a poor source of?");
                printf("\n\nA. Calcium\t\tB. Protein\n\nC. Carbohydrates\t\tD. Vitamin C");
                if (toupper(getch()) == 'D')
                {
                    printf("\n\nCorrect!!!");
                    count++;
                ...
                {
                    printf("\n\nWrong!!! The correct answer is D. Vitamin C");
                    getch();
                    break;
                }
            case 15:
                printf("\n\n\nWhich acid is present in lemon?");
                printf("\n\nA. Marlic Acid\t\tB. Lactic Acid\n\nC. Tartaric Acid\t\tD. Citric Acid");
                if (toupper(getch()) == 'D')
                {
                    printf("\n\nCorrect!!!");
                    count++;
                ...
                {
                    printf("\n\nWrong!!! The correct answer is D. Citric Acid");
                    getch();
                    break;
                }
            }
    ...
    game:
        ...
        for (i = 1; i <= 10; i++)
        {
            ...
            case 24:
                ...
                {
                    printf("\n\nWrong!!! The correct answer is B.Program");
                    getch();
                    goto score;
                    break;
                }
            case 25:
                ...
                {
                    printf("\n\nWrong!!! The correct answer is C. Centrifugation");
                    getch();
                    goto score;
                    break;
                }
            case 26:
                ...
                {
                    printf("\n\nWrong!!! The correct answer is C. Chadwick");
                    getch();
                    goto score;
                    break;
                }
            case 27:
                ...
                {
                    printf("\n\nWrong!!! The correct answer is B. Standing Position");
                    getch();
                    goto score;
                    break;
                }
            case 28:
                ...
                {
                    printf("\n\nWrong!!! The correct answer is A. Molality");
                    getch();
                    goto score;
                    break;
                }
            case 29:
                ...
                printf("\n\nA. Sodium Sulphate\t\tB. Borax\n\nC. Sodium Thiosulphate\t\tD. Ammonium Sulphate");
                if (toupper(getch()) == 'C')
                {
                    printf("\n\nCorrect!!!");
                    countr++;
                ...
                {
                    printf("\n\nWrong!!! The correct answer is C. Sodium Thiosulphate");
                    getch();
                    goto score;
                    break;
                }
            case 30:
                ...
                {
                    printf("\n\nWrong!!! The correct answer is A. Wrought Iron");
                    getch();
                    goto score;
                    break;
                }
